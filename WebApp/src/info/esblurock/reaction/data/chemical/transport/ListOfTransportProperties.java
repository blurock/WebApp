 ...
 * 
 * (0,18):  Species name
 * (19,20): geometricIndex
 * (20,30): potentialWellDepth
 * (30,40): collisionDiameter
 * (40,50): dipole
 * (50,60): polarizability
 * (60,70): collisionNumber
 * @throws IOException 
 * 
 */
            ...
            if(line == null) {
            	...
            	SpeciesTransportProperty transport = 
            			new SpeciesTransportProperty(keyword, 
            					speciesName, 
            					geometricIndex, potentialWellDepth, 
            					collisionDiameter, dipole, 
            					polarizability, collisionNumber);
            	this.add(transport);
            	line = tok.nextToken();
            } else {
            	error += "ERROR: '" + line+ "'";
