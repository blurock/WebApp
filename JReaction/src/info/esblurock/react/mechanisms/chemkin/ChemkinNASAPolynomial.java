 ...
 * @author blurock
 */
public class ChemkinNASAPolynomial implements ThermodynamicInformation {
	...
	public ChemkinNASAPolynomial() {
		reference = "ChemkinNASAPolynomial";
	}
	...
	/**
	 * Convert to a ChemkinNASAPolynomial String
	 *
	...
	public double getStandardEnthalpy298() {
		...
		try {
			...
			Logger.getLogger(ChemkinNASAPolynomial.class.getName()).log(Level.SEVERE, null, ex);
		}
		return enthalpy;
	}
